  ...
  modules: [
    {
      ...
      isOpen: true,
      lessons: [
        { id: "m1-l1", title: "Choosing the right chart for your data", type: ContentType.VIDEO, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l2", title: "Best practices for clean data visualizations", type: ContentType.VIDEO, duration: "2 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l3", title: "Formatting data for effective reporting", type: ContentType.READING, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l4", title: "Common visualization mistakes to avoid", type: ContentType.READING, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l5", title: "Design principles for clear dashboards", type: ContentType.PLUGIN, duration: "10 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l6", title: "Telling stories with your data", type: ContentType.VIDEO, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l7", title: "Origins of the data analysis process", type: ContentType.READING, duration: "8 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l8", title: "How data analysts approach tasks", type: ContentType.READING, duration: "8 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l9", title: "Cassie: Dimensions of data analytics", type: ContentType.VIDEO, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l10", title: "Create a sales performance dashboard", type: ContentType.PRACTICE, duration: "30 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l11", title: "What is the data ecosystem?", type: ContentType.VIDEO, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l12", title: "How data informs better decisions", type: ContentType.VIDEO, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l13", title: "Data and gut instinct", type: ContentType.READING, duration: "4 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l14", title: "Test your knowledge on the data ecosystem", type: ContentType.ASSIGNMENT, duration: "10 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l15", title: "Discover data skill sets", type: ContentType.VIDEO, duration: "46 sec", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l16", title: "Key data analyst skills", type: ContentType.VIDEO, duration: "6 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l17", title: "Use data analytics skills in a business scenario", type: ContentType.READING, duration: "8 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l18", title: "Practice data analyst skills", type: ContentType.PLUGIN, duration: "10 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l19", title: "Test your knowledge on data analyst skills", type: ContentType.PRACTICE, duration: "8 min", status: Status.NOT_STARTED, isLocked: false },
        { id: "m1-l20", title: "All about thinking analytically", type: ContentType.VIDEO, duration: "5 min", status: Status.NOT_STARTED, isLocked: false },
